...
def test_inner_join():
    assert inner_join([{'a': 1, 'b': 2}, {'a': 3, 'b': 4},{'e':1,'f':2}], [{'c': 1, 'd': 2}, {'c': 3, 'd': 4},{"g":1,"h":2}], 'a', 'c') == [{'a': 1, 'b': 2, 'c': 1, 'd': 2}, {'a': 3, 'b': 4, 'c': 3, 'd': 4}]

def test_left_join():
    assert left_join([{'a': 1, 'b': 2}, {'a': 3, 'b': 4},{'e':1,'f':2}], [{'c': 1, 'd': 2}, {'c': 3, 'd': 4},{"g":1,"h":2}], 'a', 'c') == [{'a': 1, 'b': 2, 'c': 1, 'd': 2}, {'a': 3, 'b': 4, 'c': 3, 'd': 4}, {'e': 1, 'f': 2}]

def test_right_join():
    assert right_join([{'a': 1, 'b': 2}, {'a': 3, 'b': 4},{'e':1,'f':2}], [{'c': 1, 'd': 2}, {'c': 3, 'd': 4},{"g":1,"h":2}], 'a', 'c') == [{'a': 1, 'b': 2, 'c': 1, 'd': 2}, {'a': 3, 'b': 4, 'c': 3, 'd': 4}, {'g': 1, 'h': 2}]

def test_full_join():
    assert full_join([{'a': 1, 'b': 2}, {'a': 3, 'b': 4},{'e':1,'f':2}], [{'c': 1, 'd': 2}, {'c': 3, 'd': 4},{"g":1,"h":2}], 'a', 'c') == [{'a': 1, 'b': 2, 'c': 1, 'd': 2}, {'a': 3, 'b': 4, 'c': 3, 'd': 4}, {'g': 1, 'h': 2}, {'e': 1, 'f': 2}]